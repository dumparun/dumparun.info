...
<head>
<!--Added by Arun to include google author tag -->
<link rel="author" href="https://plus.google.com/102180125902715106618/posts"/> 
<!-- end addition -->
	<meta charset="<?php bloginfo('charset'); ?>">
	<title><?php wp_title(''); ?></title>
	<?php mts_meta(); ?>
	<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'stylesheet_url' ); ?>" />
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/custom-style.css" media="screen" />
